...
//        editConfig.cropSize.aspectRatios.removeAll()
        ...
        editConfig.finishButtonTitleNormalColor = Constants.Color.Red
        editConfig.text.tintColor = Constants.Color.Red
        editConfig.text.doneTitleColor = Constants.Color.Red
        return editConfig
    }
