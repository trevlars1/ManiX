...
typedef NS_ENUM(NSInteger, MelonDSGameInput) {
    MelonDSGameInputTouchScreenX = 4096,
    MelonDSGameInputTouchScreenY = 8192,
    MelonDSGameInputLid = 16384,
};
...
+ (void)checkAndReadyForUrl:(NSURL *)url {
    if (![NSFileManager.defaultManager fileExistsAtPath:url.path]) {
        ...
        NSURL *fileInBundleUrl = [NSURL fileURLWithPath:[NSSearchPathForDirectoriesInDomains(NSLibraryDirectory, NSUserDomainMask, YES)[0] stringByAppendingPathComponent:[NSString stringWithFormat:@"%@/%@", @"System.core", fileName]]];
...
- (NSURL *)bios7URL
{
    NSURL *bios7url = [NSURL fileURLWithPath:[NSSearchPathForDirectoriesInDomains(NSLibraryDirectory, NSUserDomainMask, YES)[0] stringByAppendingPathComponent:[NSString stringWithFormat:@"%@/%@", @"System.core", @"bios7.bin"]]];
...
- (NSURL *)bios9URL
{
    NSURL *bios9url = [NSURL fileURLWithPath:[NSSearchPathForDirectoriesInDomains(NSLibraryDirectory, NSUserDomainMask, YES)[0] stringByAppendingPathComponent:[NSString stringWithFormat:@"%@/%@", @"System.core", @"bios9.bin"]]];
...
- (NSURL *)firmwareURL
{
    NSURL *firmwareUrl = [NSURL fileURLWithPath:[NSSearchPathForDirectoriesInDomains(NSLibraryDirectory, NSUserDomainMask, YES)[0] stringByAppendingPathComponent:[NSString stringWithFormat:@"%@/%@", @"System.core", @"firmware.bin"]]];
...
- (NSURL *)dsiBIOS7URL
{
    return [NSURL fileURLWithPath:[NSSearchPathForDirectoriesInDomains(NSLibraryDirectory, NSUserDomainMask, YES)[0] stringByAppendingPathComponent:[NSString stringWithFormat:@"%@/%@", @"System.core", @"dsibios7.bin"]]];
}

- (NSURL *)dsiBIOS9URL
{
    return [NSURL fileURLWithPath:[NSSearchPathForDirectoriesInDomains(NSLibraryDirectory, NSUserDomainMask, YES)[0] stringByAppendingPathComponent:[NSString stringWithFormat:@"%@/%@", @"System.core", @"dsibios9.bin"]]];
}

- (NSURL *)dsiFirmwareURL
{
    return [NSURL fileURLWithPath:[NSSearchPathForDirectoriesInDomains(NSLibraryDirectory, NSUserDomainMask, YES)[0] stringByAppendingPathComponent:[NSString stringWithFormat:@"%@/%@", @"System.core", @"dsifirmware.bin"]]];
}

- (NSURL *)dsiNANDURL
{
    return [NSURL fileURLWithPath:[NSSearchPathForDirectoriesInDomains(NSLibraryDirectory, NSUserDomainMask, YES)[0] stringByAppendingPathComponent:[NSString stringWithFormat:@"%@/%@", @"System.core", @"dsinand.bin"]]];
}
...
namespace Platform
{
    ...
    FILE* OpenLocalFile(std::string path, std::string mode)
    {
        ...
        NSURL *relativeURL = [[NSURL fileURLWithPath:[NSSearchPathForDirectoriesInDomains(NSLibraryDirectory, NSUserDomainMask, YES)[0] stringByAppendingPathComponent:[NSString stringWithFormat:@"%@", @"System.core"]]] URLByAppendingPathComponent:@(path.c_str())];
