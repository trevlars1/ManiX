...
@interface SNESEmulatorBridge () <MANCEmulatorBase>
...
const NSInteger SNESGameInputUp = 1;
const NSInteger SNESGameInputDown = 2;
const NSInteger SNESGameInputLeft = 4;
const NSInteger SNESGameInputRight = 8;
const NSInteger SNESGameInputA = 16;
const NSInteger SNESGameInputB = 32;
const NSInteger SNESGameInputX = 64;
const NSInteger SNESGameInputY = 128;
const NSInteger SNESGameInputL = 256;
const NSInteger SNESGameInputR = 512;
const NSInteger SNESGameInputStart = 1024;
const NSInteger SNESGameInputSelect = 2048;
...
- (void)renderAudioSamples
{
    ...
    int sampleCount = MIN((int)self.audioRenderer.audioBuffer.enableBytesForWriting / 2, S9xGetSampleCount());
