...
class PlayHistoryFavouriteCollectionCell: UICollectionViewCell {
    ...
    func setData(game: Game) {
        ...
        let image = UIImage.tryDataImageOrPlaceholder(tryData: game.gameCover?.storedData(), preferenceSize: estimated)
        iconView.image = image
        infoContainerView.backgroundColor = image.dominantBackground
