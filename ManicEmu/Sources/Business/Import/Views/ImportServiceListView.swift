...
class ImportServiceListView: BaseView {
    ...
    var addServiceButton: SymbolButton = {
        let view = SymbolButton(image: UIImage(symbol: .plus, font: Constants.Font.body(size: .m, weight: .bold), color: Constants.Color.Red))
    ...
    private func createLayout() -> UICollectionViewLayout {
        let layout = UICollectionViewCompositionalLayout { sectionIndex, env in
            ...
            group.interItemSpacing = .fixed(Constants.Size.ContentSpaceMid)
