...
//  ManicEmu
//
//  Created by Aushuang Lee on 2025/2/7.
...
class GamesToolView: UIView {
    ...
    private lazy var searchIcon: GamesToolIconView = {
        let view = GamesToolIconView(toolView: searchTextField, normalSymbol: .magnifyingglass, iconSize: Constants.Size.SymbolSize, autoLayutType: .greater(1000))
